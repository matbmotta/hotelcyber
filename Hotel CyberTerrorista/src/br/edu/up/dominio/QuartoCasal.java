...
public class QuartoCasal {
	...
	public QuartoCasal(int id, String cpf, String nome, String entrada, String saida, int numero_do_quarto, int checkIn, String itemConsumido, Double valorConsumido) {
		this.id = id;
		this.cpf = cpf;
		this.nome = nome;
